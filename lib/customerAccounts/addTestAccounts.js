...
async function addCustomerAccounts() {
    ...
    let customerQuery = await runQuery(customerPool, 'INSERT INTO customer_account(cid, username, default_delivery_address, phone_num, password_hash, email, default_credit_card) values' +
        '(1, "JohnDoe", "95 Rockafellar Rd, Piscataway, NJ 08854", "1234567890", "examplePass", "pewdiepie285@gmail.com", "1234567891234567"),' + '(2, "JaneDoe", "95 Joyce Kilmer Ave, Piscataway, NJ", "9081230000", "password1", "flacomineryt@gmail.com", "1111222200009999")');

...
const authRequirements = {
   ...
   '/order/orderHistory.html': authRoles.customer,
   '/order/orderStatus.html': authRoles.customer,
   '/customerGeolocation/customerGeolocationView.html': authRoles.customer
}

...
async function createCheckoutSession(req, res) {
    ...
    try {
        const session = await stripe.checkout.sessions.create({
            ...
            mode: 'payment',
            ui_mode: 'embedded',
            return_url: 'https://127.0.0.1:8080/?session_id={CHECKOUT_SESSION_ID}', //change this to the actual website
            });
    ...
    async function handleRefund(req, res) {
        ...
        try {
            ...
            let results = await runQuery(adminPool, updateQuery, [orderId]);

...
async function getAssignedOrders(req, res, jwtBody, eid) {
    ...
    let queryRes = await runQuery(employeePool,
        ...
        WHERE db.assignedToEmp = ${jwtBody.eid}
...
module.exports = {
    routes: [
        {
            method: 'GET',
            path: /^\/directions\/assignedOrder\/[\d]+$/,
            handler: handleWorksAt(authRoles.employee, getAssignedOrders)
        },
        {
            method: 'POST',

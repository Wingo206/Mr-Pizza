...
async function menuDataLoader() {
    ...
    await runQuery(adminPool, "INSERT INTO custom_option (option_name, mid, price, custom_name) VALUES ('Pepperoni', '1','0.25','topping'),('Sausage', '1','0.25','topping'),('Bacon', '1','0.25','topping'),('Chicken', '1', '0.25','topping'),('Mushroom', '1','0.25','topping'),('Bell-Pepper', '1','0.25','topping'),('Pineapple', '1','0.25','topping'),('Small','1','5.99','size'),('Medium','1','7.99','size'),('Large','1','11.99','size');");
    await runQuery(adminPool, "INSERT INTO custom_availability (option_name, mid, store_id, custom_name, available) VALUES ('Pepperoni', '1','1','topping','1'),('Sausage', '1','1','topping','1'),('Bacon', '1','1','topping','1'),('Chicken', '1', '1','topping','1'),('Mushroom', '1','1','topping','1'),('Bell-Pepper', '1','1','topping','1'),('Pineapple', '1','1','topping','1'),('Small','1','1','size','1'),('Medium','1','1','size','1'),('Large','1','1','size','0');");
}
